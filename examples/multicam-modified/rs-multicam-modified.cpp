    ...
    std::thread proc_d455([&]() {
        while (true)
        {
            ...
            if (d455_frames_queue.poll_for_frame(&f))
            {
                ...
                if (prev_d455_frame_count == 0) prev_d455_frame_count = d455_frame_count;
                ...
                //std::cout << prev_d455_frame_timestamp << ", " << d455_frame_timestamp << ", " << d455_frame_timestamp_diff << std::endl;
                if (d455_frame_count % 150 == 0)
                {
                    std::cout << "\033[32m" << "D455 frame: " << d455_frame_count  << "\033[0m" << std::endl;
                }
    ...
    std::thread proc_d435([&]() {
        while (true)
        {
            ...
            if (d435_frames_queue.poll_for_frame(&f))
            {
                ...
                if (prev_d435_frame_count == 0) prev_d435_frame_count = d435_frame_count;
                ...
                if (d435_frame_count % 150 == 0)
                {
                    std::cout << "\033[32m" << "D435 frame: " << d435_frame_count  << "\033[0m" << std::endl;
                }
